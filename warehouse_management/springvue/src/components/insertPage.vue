<template>
  <div class="add-user-form">
    <form @submit.prevent="saveItem">
      ...
      <input id="username" class="form-control" type="text" v-model="item.name" name="name" required><br>
      <label for="category">类别：</label>
      <input id="category" class="form-control" type="text" v-model="item.category" name="category" required><br>
      <label for="description">描述：</label>
      <input for="description" class="form-control" type="text" v-model="item.description" name="description" required><br>
      <label for="stock">货存：</label>
      <input id="stock" class="form-control" type="text" v-model="item.stock" name="stock" required><br>
      <label for="stock">价格：</label>
      <input id="stock" class="form-control" type="text" v-model="item.price" name="price" required><br>
...
export default {
  ...
  methods: {
    ...
    saveItem() {
      // 设置创建时间为当前时间
      this.item.create_time = new Date().toISOString();
